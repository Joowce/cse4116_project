...
import com.android.server.huins.HuinsSystemServiceImpl;
...
class ServerThread {
    ...
    public void initAndLoop() {
		...
		ServiceManager.addService(Context.HUINS_SYSTEM_SERVICE, new HuinsSystemServiceImpl(context));
		Slog.i(TAG, "Huins System Service Started");	
	    } catch (Throwable e) {
		Slog.e(TAG, "Failure starting Huins systerm service", e);
	    }
        }
